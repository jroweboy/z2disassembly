...
.import L_Bank6Code0
.import bank7_Table_for_some_Palettes
...
LB242:                                                                         ;
    LDA      $073B                     ; 0x17252 $B242 AD 3B 07                ;
...
bank5_Load_Saved_Games_Data:                                                    ;
    ...
    BNE      bank5_Load_Saved_Games_Data_Frame_2 ; 0x17280 $B270 D0 09         ;
    ...
    RTS                                ; 0x1728a $B27A 60                      ;
                                                                               ;
; ---------------------------------------------------------------------------- ;
bank5_Load_Saved_Games_Data_Frame_2:                                           ; On the second frame after the first pass, this adds a little extra configuration and then draws the background
    DEY                                ; 0x1728b $B27B 88                      ;
    BNE      bank5_Load_Saved_Games_Data_Frame_3 ; 0x1728c $B27C D0 0D         ;
    ...
    RTS                                ; 0x1729a $B28A 60                      ;
                                                                               ;
; ---------------------------------------------------------------------------- ;
bank5_Load_Saved_Games_Data_Frame_3:                                           ; This is the final frame for drawing the File Select menu.
